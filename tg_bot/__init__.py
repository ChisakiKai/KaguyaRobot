...
log.info("Kaguya is starting. | An Zero Union Project. | Licensed under GPLv3.")

log.info("Not affiliated to College or Levels in any way whatsoever.")
log.info("Project maintained by: github.com/ChisakiKai (t.me/ChisakiKai/KaguyaRobot)")
...
telethn = TelegramClient("kaguya", APP_ID, API_HASH)
